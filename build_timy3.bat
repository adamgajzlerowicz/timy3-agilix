@echo off
echo Building Timy3 application...
...
echo Executable created successfully with timestamp:
dir "bin\Debug\AlgeTimyUsb.SampleApplication.exe"

echo.
echo Build complete! The executable is located at:
echo AlgeTimyUsb.SampleApplicationCSharp\bin\Debug\AlgeTimyUsb.SampleApplication.exe
echo.
